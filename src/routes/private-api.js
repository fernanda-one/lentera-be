...
import { upload } from "../middleware/upload-middleware.js"; // Importing the 'upload' variable instead of 'fileStorage'
...
// File Upload
privateRouter.post("/api/file", upload.single('file'), fileController.handleUpload);
